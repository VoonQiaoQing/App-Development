import shelve, reviewUser

from flask import Flask, render_template, request, redirect, url_for

from reviewForms import CreateUserForm
...
def create_review():
    ...
    if request.method == 'POST' and create_user_form.validate():
        ...
        user = reviewUser.User(create_user_form.rating.data, create_user_form.review.data)
        ...
        print(user.get_rating(), user.get_review(), 'was stored in storage.db successfully with user_id ==',
              user.get_user_id())
        db.close()
...
def retrieve_reviews():
    ...
    return render_template('RetrieveReviews.html', reviewcount=len(users_list), users_list=users_list)
...
def update_review(id):
    ...
    if request.method == 'POST' and update_user_form.validate():
        ...
        update_user_form.review.data = user.get_review()
