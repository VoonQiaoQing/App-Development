...
def create_question():
    ...
    if request.method == 'POST' and create_user_form.validate():
        ...
        user = User.User(create_user_form.Question.data, create_user_form.Reason.data, create_user_form.Availability.data, create_user_form.NumberOfPeople.data, create_user_form.remarks.data)
...
def update_user(id):
    ...
    if request.method == 'POST' and update_user_form.validate():
        ...
        user.set_Reason(update_user_form.Reason.data)
        ...
        update_user_form.Reason.data = user.get_Reason()
